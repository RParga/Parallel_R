...
entrenamiento <- ceiling(0.7 * tmax) # conjunto de entrenamiento
prueba <- tmax - entrenamiento # conjunto de prueba
if (dibuja) {
...
for (t in 1:tmax) {
    x <- runif(1)
    y <- runif(1)
    deseada <- x > y #funcion deseada
    entrada <- c(x, y) #dato de entrada
