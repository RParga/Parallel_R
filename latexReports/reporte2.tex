...
\begin{figure}
  ...
  \caption{Distribución de los tamaños para el experimento equiprobable del Extra 1}
  \label{fig::figura4} 
\end{figure}
\begin{figure}
  \centering
  \includegraphics[width=0.26\textheight]{DistribucionTamaniosEqTE1}
  \caption{Distribución de tamaños de las poblaciones centrales de todos los experimentos equiprobables del Extra 1}
  \label{fig::figura5} 
\end{figure}
...
\begin{figure}
  ...
  \caption{Distribución de los tamaños para el mismo experimento no equiprobable del Extra 1}
  \label{fig::figura7} 
\end{figure}
\begin{figure}
  \centering
  \includegraphics[width=0.26\textheight]{DistribucionTamaniosNETE1}
  \caption{Distribución de tamaños de las poblaciones centrales de todos los experimentos no equiprobables del Extra 1}
  \label{fig::figura8} 
\end{figure}
...
\begin{figure}
  ...
  \caption{Distribución de los tamaños para el mismo experimento equiprobable del Extra 2}
  \label{fig::figura10} 
\end{figure}
\begin{figure}
  \centering
  \includegraphics[width=0.26\textheight]{DistribucionTamaniosEqTE2}
  \caption{Distribución de tamaños de las poblaciones centrales de todos los experimentos equiprobables del Extra 2}
  \label{fig::figura11} 
\end{figure}
...
\begin{figure}
  ...
  \caption{Distribución de los tamaños para el mismo experimento no equiprobable del Extra 2}
  \label{fig::figura13} 
\end{figure}
\begin{figure}
  \centering
  \includegraphics[width=0.26\textheight]{DistribucionTamaniosNETE2}
  \caption{Distribución de tamaños de las poblaciones centrales de todos los experimentos no equiprobables del Extra 2}
  \label{fig::figura14} 
\end{figure}
