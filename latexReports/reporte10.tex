...
\begin{figure}[ht!]
  ...
  \caption{Comparación de los residuales del porcentaje de separación y el tipo}
  \label{fig::figura2} 
\end{figure}
...
\begin{figure}[ht!]
  ...
  \caption{Comparación de los residuales del procentaje de separación y el tipo}
  \label{fig::figura6} 
\end{figure}
...
En la figura \ref{fig::figura8} vemos la comparación entre los 2
